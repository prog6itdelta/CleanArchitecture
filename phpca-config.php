...
//            '/excluded/vendor/package/dir',
    ...
    'components' => [
        [
            ...
            'roots' => [
                [
                    'path' => __DIR__ . '/app/Packages/Common/Domain',
                    'namespace' => 'App\Packages\Common\Domen',
                ],
                [
                    'path' => __DIR__ . '/app/Packages/Learn/Entities',
        ...
        [
            ...
            'roots' => [
                [
                    'path' => __DIR__ . '/app/Packages/Common/Application',
                    'namespace' => 'App\Packages\Common\Application',
                ],
                [
                    'path' => __DIR__ . '/app/Packages/Learn/UseCases',
        ...
        [
            ...
            'roots' => [
                [
                    'path' => __DIR__ . '/app/Packages/Common/Infrastructure',
                    'namespace' => 'App\Packages\Common\Infrastructure',
                ],
                [
                    'path' => __DIR__ . '/app/Packages/Learn/Infrastructure',
                    'namespace' => 'App\Packages\Learn\Infrastructure',
                ],
            ],
        ],
        [
            ...
            'roots' => [
                [
                    'path' => __DIR__ . '/app/Packages/Utils',
...
//            'roots' => [
//                [
//                    'path' => __DIR__ . '/app/Http/Controllers',
...
//            'roots' => [
//                [
//                    'path' => __DIR__ . '/app/Http/Middleware',
...
//            'roots' => [
//                [
//                    'path' => __DIR__ . '/app/Packages/Learn',
//                    'namespace' => 'App\Packages\Learn',
//                ],
